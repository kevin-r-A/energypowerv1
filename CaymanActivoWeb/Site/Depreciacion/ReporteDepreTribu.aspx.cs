...
public partial class ReporteDepreNiif : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {            
            this.Title = ConfigurationManager.AppSettings["Titulo"] + " Consultar Depreciación TRIBUTARIA Generada";
            cargarmeses();
        }
    }
    ...
    {
        ddmeses.Items.Clear();
        DataTable dt = Logica.HELPER.getMesDepre2("TRIBUTARIA");

        int i = 0;
        foreach (DataRow row in dt.Rows)
        {

            DateTime dtime = DateTime.ParseExact(row[0].ToString(),"dd/MM/yyyy", CultureInfo.InvariantCulture); //Convert.ToDateTime(row[0].ToString());
