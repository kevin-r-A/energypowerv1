...
public partial class Site_Mantenimiento_IngresadeMant_IngresodeMantenimiento : System.Web.UI.Page
{
    ...
    protected void ibsave_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            DataTable dt = Logica.HELPER.getReporteEnviadosMantenimiento(query);
    ...
    protected void rblBuscar_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (rblBuscar.Items[0].Selected == true)
        {
            ...
            txtbusbnf.Enabled = false;
            txtbusbnf.Text = "";
            ibbus2.Enabled = false;
        ...
        else if (rblBuscar.Items[1].Selected == true)
        {
            panFiltros.Visible = false;
            upconsult.Visible = false;
            txtbuscb.Enabled = false;
            ibbus1.Enabled = false;
            txtbusbnf.Enabled = true;
            ibbus2.Enabled = true;
            txtbusbnf.Text = "";
            rgreporte.DataSource = null;
            rgreporte.DataBind();
        ...
        try
        {
            ...
            if (codigoCorrecto())
            {
                if (Logica.HELPER.comprobarCbIngresado(txtbuscb.Text))
                {
                    ...
                    DataTable dt = Logica.HELPER.getReporteEnviadosMantenimiento(" and ACT_CODBARRAS = '" + txtbuscb.Text.Trim() + "'");
                    ...
                    {
                        btnActivarItem.Enabled = false;
                        messbox1.Mensaje = "Activo No ha sido Enviado a Mantenimiento!";
                        messbox1.Tipo = "I";
                        messbox1.showMess();
                    }
        ...
        if (verificaItemsSel())
        {
            ...
            foreach (GridViewRow rw in rgreporte.Rows)
            {
                ...
                if (check.Checked == true)
                {
                    ...
                    err = Logica.Mantenimiento.ActualizaEstadoMant("", "A", Membership.GetUser().UserName.ToString(), 2, int.Parse(rw.Cells[2].Text.Trim()));
            ...
            DataTable dt = Logica.HELPER.getReporteEnviadosMantenimiento(Session["query"].ToString());
    ...
    protected void btnActivarItem_Click(object sender, EventArgs e)
    {
        if (verificaItemsSel())
        {
            ...
            foreach (GridViewRow rw in rgreporte.Rows)
            {
                ...
                if (check.Checked == true)
                {
                    err = Logica.Mantenimiento.ActualizaEstadoMant(rw.Cells[4].Text.Trim(), "A", Membership.GetUser().UserName.ToString(), 1, 0);
    ...
    protected void ibbus2_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (Logica.HELPER.comprobarCodSecundarioIngresado(txtbusbnf.Text.Trim()))
            {
                ...
                DataTable dt = Logica.HELPER.getReporteEnviadosMantenimiento(" and ACT_CODIGO1 = '" + txtbusbnf.Text.Trim() + "'");
            ...
            {
                //panuevo.Visible = false;
                messbox1.Mensaje = "Código Secundario: " + txtbusbnf.Text.Trim() + ", aún no ha sido ingresado!";
                messbox1.Tipo = "I";
                messbox1.showMess();
            }
