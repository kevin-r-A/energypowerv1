<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Activos/cay.master" AutoEventWireup="true" CodeFile="AutDesFiltros.aspx.cs" Inherits="AutDesFiltros" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="cph1">
    <asp:Panel ID="panGeneral" runat="server" CssClass="panmar" 
                            GroupingText="Activa/Desactiva Filtros" >       
                                    ...
                                    <table cellpadding="2" cellspacing="0" class="style1" id="tblFiltros" runat="server">
                                        ...
                                        <tr>
                                            <td>
                                                Ingreso:</td>
                                            <td>
                                                <asp:DropDownList ID="ddtipoing" runat="server" CssClass="txtdd">
                                                </asp:DropDownList>
                                        ...
                                        <tr>
                                            <td>
                                                Garantía:</td>
                                            <td>
                                                <asp:DropDownList ID="ddgarantia" runat="server" CssClass="txtdd">
                                            ...
                                            <td class="aatr" height="36">
                                                <asp:UpdatePanel ID="upconsult" runat="server" UpdateMode="Conditional" Visible ="false">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:Button ID="btnActivar0" runat="server" BorderColor="#0099FF" 
                                                            Font-Bold="True" ForeColor="#333333" Height="28px" onclick="btnActivar_Click" 
                                                            Text="Filtrar Items" Width="102px" />
                                                        <br />
                                                        <br />
                                                        <asp:Button ID="btnDesactiva" runat="server" BorderColor="#0099FF" 
                                                            Font-Bold="True" ForeColor="#333333" Height="28px" onclick="btnDesactiva_Click" 
                                                            Text="No Filtrar Items" Width="102px" />
                                                        <br>
                                                        <br>
                                            ...
                                            <asp:RadioButtonList ID="rblBuscar" runat="server" AutoPostBack="True" 
                                                ...
                                                <asp:ListItem Value="F">Filtros</asp:ListItem>
                                                                        ...
                                                                        <td colspan="4">
                                                                            <table class="style21">
                                                                                ...
                                                                                <asp:RequiredFieldValidator ID="rfv_codbarras" runat="server" 
                                                                                    ControlToValidate="txtbuscb" ErrorMessage="Ingrese Código Barras" 
                                                                                ...
                                                                                <telerik:RadTextBox ID="txtbuscb" runat="server" MaxLength="20" Width="105px">
                                                                ...
                                                                <asp:ImageButton ID="ibxls1" runat="server" Height="30px" 
                                                                    ImageUrl="~/Img/xls1.png" onclick="ibxls1_Click" Width="122px" CssClass="style29" />
                                                                                    </td>
                                                                                    <td>
                                                                                        &nbsp;</td>
                                                                                    <td>
                                                    ...
                                                    <table class="style1">
                                                        <tr>
                                                            <td class="style35">
                                                                &nbsp;</td>
                                                            <td>
                                                                <asp:Button ID="btnActivarItem" runat="server" BorderColor="#0099FF" 
                                                                    Font-Bold="True" ForeColor="#333333" Height="30px" Text="Filtrar Item" 
                                                                    Width="122px" onclick="btnActivarItem_Click" />
                                                                <asp:Button ID="btnDesactivaitem" runat="server" BorderColor="#0099FF" 
                                                                    Font-Bold="True" ForeColor="#333333" Height="30px" 
                                                                    Text="No Filtrar Item" Width="122px" onclick="btnDesactivaitem_Click"  />
                                                            </td>
                                                            <td>
                                                                &nbsp;</td>
                                                            <td>
