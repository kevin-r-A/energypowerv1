<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Activos/cay.master" AutoEventWireup="true" CodeFile="ExplorerPdf_BajaActas.aspx.cs" Inherits="Site_Activos_ExplorerPdf_BajaActas" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="cph1">
    ...
    <asp:Panel ID="pantras" runat="server" CssClass="panmar" 
        GroupingText="Actas Generadas de Activos Dados de Baja">
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:HyperLink ID="systemLink" runat="server" 
                                                NavigateUrl='<%# string.Concat("PDF_ACTBAJA/" , DataBinder.Eval(Container, "DataItem.Name") ) %>' 
