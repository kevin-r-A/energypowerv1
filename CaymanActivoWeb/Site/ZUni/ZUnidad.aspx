<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Activos/cay.master" AutoEventWireup="true" CodeFile="ZUnidad.aspx.cs" Inherits="ZUnidad" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" CssClass="panmar" 
        GroupingText="Gestión de Unidades">
        <table cellspacing="0" class="panmar">
            <tr>
                <td class="aatl" width="100%">
                    <asp:Panel ID="Panel5" runat="server" CssClass="panmar" GroupingText="Unidades">
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="pangru1" runat="server" CssClass="panmar2">
                                    <asp:ImageButton ID="ibgr7" runat="server" CausesValidation="False" 
                                        ...
                                        TabIndex="99" ToolTip="Agregar Unidad" Width="21px" />
                                    &nbsp;<asp:ImageButton ID="ibgr8" runat="server" CausesValidation="False" 
                                        ...
                                        TabIndex="99" ToolTip="Editar Unidad" Width="21px" />
                                    &nbsp;<asp:ImageButton ID="ibgr9" runat="server" CausesValidation="False" 
                                        ...
                                        TabIndex="99" ToolTip="Eliminar Unidad" Width="20px" />
                                </asp:Panel>
                                <telerik:RadListBox ID="rlbunidad" runat="server" AutoPostBack="True" 
                                    CssClass="panmar" EmptyMessage="Unidades no Disponibles" Height="450px" 
                                    Width="95%">
                                ...
                                <table cellspacing="0" width="409">
                                    <tr>
                                        ...
                                        <td class="auto-style2">
                                            <h6><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
