<%@ Page Language="C#" MasterPageFile="~/Site/Activos/cay.master" AutoEventWireup="true" CodeFile="ExplorerPdf_Mant.aspx.cs" Inherits="Site_Mantenimiento_ExplorerPdf_Mant" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="cph1">
    ...
    <asp:Panel ID="pantras" runat="server" CssClass="panmar" 
        GroupingText="Documentos Adjuntos Mantenimientos">
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:HyperLink ID="systemLink" runat="server" 
                                                NavigateUrl='<%# string.Concat("NuevoMant/docmant/" , DataBinder.Eval(Container, "DataItem.Name") ) %>' 
