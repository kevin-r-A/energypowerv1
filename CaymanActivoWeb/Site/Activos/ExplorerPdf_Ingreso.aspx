<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Activos/cay.master" AutoEventWireup="true" CodeFile="ExplorerPdf_Ingreso.aspx.cs" Inherits="ExplorerPdf_Ingreso" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="cph1">
    ...
    <asp:Panel ID="pantras" runat="server" CssClass="panmar" 
        GroupingText="Actas Generadas Ingreso Activos y Bienes de Control">
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:HyperLink ID="systemLink" runat="server" 
                                                NavigateUrl='<%# string.Concat("pdf_acting/" , DataBinder.Eval(Container, "DataItem.Name") ) %>' 
