                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:HyperLink ID="systemLink" runat="server" 
                                                NavigateUrl='<%# string.Concat("Logs/" , DataBinder.Eval(Container, "DataItem.Name") ) %>' 
                                                Target="_blank">Abrir Archivo &gt;&gt;</asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="Name" HeaderText="Log del Sistema" />
