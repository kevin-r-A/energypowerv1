<%@ Page Language="C#" MasterPageFile="~/Site/Activos/cay.master" AutoEventWireup="true" CodeFile="ExplorerPdf_Actas.aspx.cs" Inherits="Site_Mantenimiento_ExplorerPdf_Actas" %>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:HyperLink ID="systemLink" runat="server" 
                                                NavigateUrl='<%# string.Concat("NuevoMant/PDF/" , DataBinder.Eval(Container, "DataItem.Name") ) %>' 
