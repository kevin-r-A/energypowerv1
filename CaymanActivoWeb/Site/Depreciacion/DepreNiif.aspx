<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Activos/cay.master" AutoEventWireup="true" CodeFile="DepreNiif.aspx.cs" Inherits="DepreNiif" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cph1">
    ...
    <asp:Panel ID="panbus" runat="server" CssClass="panmar"
        GroupingText="Generar Depreciación NIIF">
        <table cellspacing="0" class="panmar2">
            <tr>
                ...
                <td class="auto-style2">&nbsp;<asp:DropDownList ID="ddmeses" runat="server" Width="170px" CssClass="txtdd">
                </asp:DropDownList>
                </td>
                <td class="aacl">
        ...
        <tr>
            <td class="aatl">
                <telerik:RadGrid ID="rgdepre" runat="server"
                    ...
                    <MasterTableView DataKeyNames="Id"
                        ...
                        <Columns>
                            ...
                            <telerik:GridNumericColumn DataField="ValorCompra" DataFormatString="{0:C}"
                            ...
                            <telerik:GridNumericColumn DataField="ValorResidual" DataType="System.Decimal"
                                ...
                                UniqueName="ValorResidual" DataFormatString="{0:C}" Aggregate="Sum"
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                    ...
                    SelectCommand="usp_getDepreciacionGenerada"
