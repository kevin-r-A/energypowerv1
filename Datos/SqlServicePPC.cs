...
namespace Datos
{
    ...
    public class SqlServicePPC
    {
        ...
        #region Contructors
        public SqlServicePPC()
        {
           // _connectionString = @"Data Source=\My Documents\Personal\sacs.sdf;Password=123";
            _connectionString = @"Data Source=C:\Users\cayman\Desktop\reslpaldo pdvsa gye\lunes15\juan\sacs.sdf;Password=123";
        }

        public SqlServicePPC(string connectionString)
        {
            _connectionString = connectionString;
        }

        public SqlServicePPC(SqlConnection connection)
        {
