<%@ Page Title="" Language="C#" MasterPageFile="~/Site/Activos/cay.master" AutoEventWireup="true" CodeFile="AutDesItems.aspx.cs" Inherits="AutDesItems" EnableEventValidation="false" %>
...
<asp:Panel ID="panGeneral" runat="server" CssClass="panmar" 
                            GroupingText="Activa/Desactiva Items" >       
                                                ...
                                                <asp:UpdatePanel ID="upconsult" runat="server" UpdateMode="Conditional" Visible ="false">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:Button ID="btnActivar0" runat="server" BorderColor="#0099FF" 
                                                            ...
                                                            Text="Activar Items" Width="102px" />
                                                        <br />
                                                        <br />
                                                        <asp:Button ID="btnDesactiva" runat="server" BorderColor="#0099FF" 
                                                            ...
                                                            Text="Desactivar Items" Width="102px" />
                                                        <br>
                                                        <br>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Button ID="btnActivarItem" runat="server" BorderColor="#0099FF" 
                                                                    Font-Bold="True" ForeColor="#333333" Height="30px" Text="Activar Item" 
                                                                ...
                                                                <asp:Button ID="btnDesactivaitem" runat="server" BorderColor="#0099FF" 
                                                                    ...
                                                                    Text="Desactivar Item" Width="122px" onclick="btnDesactivaitem_Click"  />
                                                            </td>
                                                            <td>
                                                                &nbsp;</td>
                                                            <td>
